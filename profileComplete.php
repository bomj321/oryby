...
include('navh.php');
 ...
 <form  action="profileComplete_action.php" method="POST" enctype="multipart/form-data">
                               ...
                               <center>	<h2>Company Information </h2></center>
									...
									<div class="form-group">
                                        ...
                                        <span>Phone Number:</span>
											<input name="p1" type="text" size="12" placeholder="Code" required>
											<input name="p2" type="text" size="18" placeholder="SSN #" required>
											<input name="p3" type="text"  size="56" placeholder=" Number here" required>
					...
					<option value="Zimbabwe">Zimbabwe</option>
									...
									<div class="form-group">
										<select required name="businessType"  class="form-control input">
					        ...
					        <input  id="files" class="form-control" type="file" required name="file1" />
						</div>
												<div="form-group">
 ...
 <div id="selectedFiles"></div>
						...
						<label> Your Company license </label>		
					        <input id="files1" class="form-control" type="file" required name="file2[]" multiple="multiple" />
									...
									<div class="form-group">
										<div class="row">
											...
											<div class="col-sm-6 col-sm-offset-3">
													  ...
													  <center><button type="submit" name="save" class="btn btn-default" style="border-style:solid;border-width:1px;border-color:gray;color:#066;background:#ccc"><i class="fa fa-floppy-o" >
       &nbsp; SAVE</i>
        </button>
