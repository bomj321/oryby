	...
	include('middlebar.php');
	 ...
	 <!-- end topBar -->
	   ...
	   ?>
		...
		$qry1="SELECT * FROM aboutus WHERE elementname='startbuyingelement1'"; 
	   ...
	   $rw['description'];
		?>
			  ...
			  <div class="row">
                    <div class="col-sm-8 col-sm-offset-2">
                        <div class="title-wrap">
                            <h2 class="title lines">Start Buying</h2>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <?php
                        $sql="Select * from `images` Where id='19'";
			...
			<?php
			$qry2="SELECT * FROM aboutus WHERE elementname='startbuyingelement2'"; 
	   ...
	   $rw2['description'];
		?>
					  <div class="col-sm-4">
						...
						<?php
			$qry3="SELECT * FROM aboutus WHERE elementname='startbuyingelement3'"; 
	   ...
	   $rw3['description'];
		?>
					  <div class="col-sm-4">
                        ...
                        <?php
                        $sql="Select * from `images` Where id='21'";
                        $result=mysqli_query($connection,$sql);
                        $row=mysqli_fetch_array($result);
                        $image=$row['image'];
                        ?>
