        ...
        <footer class="footer">
            <div class="container">
                <div class="row">
                    <div class="col-sm-3">
                        <div class="icon-boxes style1">
                            ...
                            <div class="box-content">
                                <h6 class="alt-font text-light text-uppercase">Envío gratis</h6>
                    ...
                    <div class="col-sm-3">
                        <div class="icon-boxes style1">
                            ...
                            <div class="box-content">
                                <h6 class="alt-font text-light text-uppercase">Tarjetas de regalo</h6>
                                <p class="text-gray">Aenean semper lacus sed molestie sollicitudin.</p>
                            </div>
                        </div><!-- icon-box -->
                    </div><!-- end col -->
                    <div class="col-sm-3">
                        <div class="icon-boxes style1">
                            ...
                            <div class="box-content">
                                <h6 class="alt-font text-light text-uppercase">Pago 100% seguro</h6>
                                <p class="text-gray">Aenean semper lacus sed molestie sollicitudin.</p>
                            </div>
                        </div><!-- icon-box -->
                    </div><!-- end col -->
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        ...
                        <ul class="list alt-list">
                            <li><a href="my-account.html"><i class="fa fa-angle-right"></i>Mi cuenta</a></li>
                            <li><a href="wishlist.html"><i class="fa fa-angle-right"></i>Deseados</a></li>
                            <li><a href="cart.html"><i class="fa fa-angle-right"></i>Mi carrito</a></li>
                            <li><a href="checkout.html"><i class="fa fa-angle-right"></i>Mi carrito</a></li>
                        </ul>
                    </div><!-- end col -->
                    <div class="col-sm-3">
                        <h5 class="title">Información</h5>
                        <ul class="list alt-list">
                            <li><a href="about-us-v1.html"><i class="fa fa-angle-right"></i>Sobre nosotros</a></li>
                            <li><a href="faq.html"><i class="fa fa-angle-right"></i>Preguntas más frecuentes</a></li>
                            <li><a href="privacy-policy.html"><i class="fa fa-angle-right"></i>Política de privacidad</a></li>
                            <li><a href="contact-v1.html"><i class="fa fa-angle-right"></i>Contáctenos</a></li>
                        </ul>
                    </div><!-- end col -->
                    <div class="col-sm-3">
                ...
                <div class="row text-center">
                    <div class="col-sm-12">
                        <p class="text-sm">&COPY; 2017. Hecho con <i class="fa fa-heart text-danger"></i> por <a href="javascript:void(0);">DiamondCreative.</a></p>
                    </div><!-- end col -->
                </div><!-- end row -->
            </div><!-- end container -->
        </footer>
