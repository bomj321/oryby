...
$sql="UPDATE aboutus  SET  hreflink='".$hreflink."',picture='".$image."'  WHERE (id='$id')";
										...
										<form method="post" enctype="multipart/form-data" class="form-horizontal">
											...
											<fieldset>
												...
												<fieldset>
													...
													<div class="form-group">
														<label>Picture</label><?php echo $image ?>
														<img style="height:150px; width:250px;"src="../images/<?php echo $image ?>">
