...
$row=mysqli_fetch_array($stmtt);
 $user_id =$row['user_id'];
  $sql="SELECT * FROM users INNER JOIN access  ON  (users.user_id = access.user_id) INNER JOIN page  ON  (access.pageId = page.pageId) WHERE  access.status ='1'  AND access.pageId='19' AND access.user_id='$user_id' ";
...
?>
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li>Casa</li><li>Crear</li><li>Cuentas</li>
				</ol>
				<!-- end breadcrumb -->
...
Necesario para verificar su cuenta</b> </label>
									</section>

									<section>
										<label class="input"> <i class="icon-append fa fa-lock"></i>
											<input type="password" name="password" onchange="form.passwordConfirm.pattern = this.value;"  title="Please Enter Alphabet and Numeric character" pattern="(?=.*[a-z || A-Z]).{6,}" required placeholder="Password" id="password">
										...
										<section class="col col-6">
											<label class="select">
												<select name="role">
													...
													<option value="0" selected="" disabled="" >Seleccionar tipo de empleado</option>
