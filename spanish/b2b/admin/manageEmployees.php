...
?>
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li>Casa</li><li>Mesas</li><li>Tablas de datos</li>
				</ol>
				<!-- end breadcrumb -->
					...
					<div class="row">
						...
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
								...
								-->
										<center><a href="emp_add.php" class="btn btn-primary"><i class="fa fa-floppy"></i> Agregar empleados</a> <a href="createaccount.php" style="margin-left:5px;"class="btn btn-primary"><i class="fa fa-floppy"></i> Crear una cuenta</a>
           </br>
