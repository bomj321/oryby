...
Seleccione para chatear con los usuarios</h1>
             </center>
            <h1 class="title">
Tus chats </h1>
...
if (strpos($a, $row['sender']) !== false) {
  ...
  <span style="color:black;font-size:15px"><?php echo $row['sender']; ?>  </span>
    ...
    <span style="float:right;"><a href="artistchatting.php?userid=<?php echo $row['sender']?>">Ver el chat</a></span> 
