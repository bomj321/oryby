					...
					<div class="row">
						...
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
								...
								-->
									<center><a href="privacy_add.php" class="btn btn-primary"><i class="fa fa-floppy"></i>Agregar contenido</a>
           </br>
         
        </center>
								<header>
									<span class="widget-icon"> <i class="fa fa-table"></i> </span>
									<h2>Página de política de privacidad </h2>
...
Título</th>
											...
											<td><?php echo $row['point4']; ?></td>
												...
												<td> 
         <a    href="javascript:contact_Id(<?php echo $row['id'];?>)"><i class="fa fa-trash-o fa-lw"></i></a> &nbsp; &nbsp;&nbsp; &nbsp; <a    href="updatePolicy.php?id=<?php echo $row['id'];?>"><i class="fa fa-pencil fa-fw"></i></a></td>
												</tr>
								<?php
								}
								}
