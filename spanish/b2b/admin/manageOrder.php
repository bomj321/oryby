...
$row=mysqli_fetch_array($stmtt);
 $user_id =$row['user_id'];
  $sql="SELECT * FROM users INNER JOIN access  ON  (users.user_id = access.user_id) INNER JOIN page  ON  (access.pageId = page.pageId) WHERE  access.status ='1'  AND access.pageId='12' AND access.user_id='$user_id' ";
						...
						while($row =mysqli_fetch_assoc($stmt))
											...
											?>
												<tr>
													...
													<td><?php echo $row['paymenttype']; ?>
						
													</td>
													<td><?php echo $row['orderquantity']; ?>
								...
								<select  class="form-group"  id="catid" name="catid" >
									
					 <option  class="form-control" value="<?php echo $row['orderstatus']; ?>"><?php echo $row['orderstatus']; ?></option>
					  <option class="form-control" value="Incomplete" >Incompleto </option>
					  <option class="form-control" value="Pending" >
Pendiente </option>
					 <option class="form-control" value="Delivered" >
Entregado </option>
					 <option class="form-control" value="Recieved" >
Recibido </option>
					 	 <option class="form-control" value="Completed" >
Terminado </option>
		 ...
		 </form>&nbsp; &nbsp;&nbsp; &nbsp;<a    href="javascript:contact_Id(<?php echo $row['order_id'];?>)"><i class="fa fa-trash-o fa-lw"></i></a>
		 &nbsp; &nbsp;&nbsp; &nbsp;<a    href="viewOrderDetail.php?id=<?php echo $row['order_id'];?>"><i class="fa fa-eye"></i></a>
</td> 
												</tr>
								<?php
								}
