			...
			<div id="content">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-home"></i> Tablero <span>Tablero de administración</span></h1>
					</div>
...
ACCIÓN</th>
												...
												<tbody>
													<tr>
														...
														<td> <a    href="profileupdate.php?userId=<?php echo $row['user_id'];?>"><i class="fa fa-pencil fa-fw"></i></a></td>
													</tr>
												</tbody>
											</table>
