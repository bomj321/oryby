...
$row=mysqli_fetch_array($stmtt);
 $user_id =$row['user_id'];
  $sql="SELECT * FROM users INNER JOIN access  ON  (users.user_id = access.user_id) INNER JOIN page  ON  (access.pageId = page.pageId) WHERE  access.status ='1'  AND access.pageId='15' AND access.user_id='$user_id' ";
					...
					<div class="row">
						...
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
								...
								-->
									<center><a href="chile_add.php" class="btn btn-primary"><i class="fa fa-floppy"></i> Añadir imagen</a>
           </br>
         
        </center>
								<header>
									<span class="widget-icon"> <i class="fa fa-table"></i> </span>
									<h2>Administrar la página de imágenes de Chile </h2>
...
Imagen</th>
											...
											?>
												...
												<td> 
         <a    href="javascript:contact_Id(<?php echo $row['id'];?>)"><i class="fa fa-trash-o fa-lw"></i></a> &nbsp; &nbsp;&nbsp; &nbsp; <a    href="updateChile.php?id=<?php echo $row['id'];?>"><i class="fa fa-pencil fa-fw"></i></a></td>
												</tr>
								<?php
								}
								}
...
function contact_Id(id)
{
   if(confirm('Sure To Remove This Record ?'))
     {
          window.location.href='deleteChile.php?aboutid='+id;
     }
     else
     {
