...
Sobre nosotros
					...
					<div class="row">
						...
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
								...
								-->
									<center><a href="about_add.php" class="btn btn-primary"><i class="fa fa-floppy"></i>Agregar contenido</a>
           </br>
		...
		<?php
include('Connect.php');
 $sql="SELECT * FROM aboutus Where elementname ='content1' OR elementname='content2'";
