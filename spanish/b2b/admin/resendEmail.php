						...
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
								...
								<header>
									...
									<h2>Página de correo electrónico de confirmación </h2>
				...
				<div class="row">
						...
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
								...
								<header>
									<span class="widget-icon"> <i class="fa fa-table"></i> </span>
									<h2>Correo electrónico de confirmación reenviar </h2>
...
Clave de confirmación</th>
											...
											?>
												<tr>
													...
													{
													?>
													<p class="btn btn-success" href="#">
Ya confirma</p>
													<?php	}else if($status == '0')
													{
													?>
													<p class="btn btn-warning" href="#">
Aún no confirmo</p>
													<?php
													}?></td>
