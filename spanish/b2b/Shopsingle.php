                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h2 class="title"><?php echo $title; ?></h2> <br>
                                 ...
                                 <h6 style="display:inline;"> Detalle de Envio:</h6> <li><p class="text-primary">20 días después del pago</p></li>  <br>
								 <h6 style="display:inline;">Método de pago:</h6> <li><p class="text-primary">PayPal</p></li> 
                                       <!-- <li>
                        ...
                        <div class="row">
                            ...
                            <form action="mycartArry.php?pid=<?php echo $pid; ?>" method="post" >        
                               ...
                               <hr class="spacer-15">
                                ...
                                <ul class="list list-inline">
     <li>
	 <button type="submit"  class="btn btn-default btn-md round"><i class="fa fa-shopping-basket mr-5"></i>Compra ahora</button></li>
	 </form>
     <li><button type="button" class="btn btn-gray btn-md round" data-toggle="modal" data-target="#myModal"><i class="fa fa-heart mr-5"></i>
Preguntar al proveedor</button></li>
  ...
  ?>
                  <hr class="spacer-60">
				         <div class="row">
							...
							<h5 style="margin-top:20px;">nombre de empresa : <label class="text-primary"><?php echo $row['company_name'];?></label></h5>
							<h5>Tipo de país / negocio : <label class="text-primary"><?php echo $row['countryName'];?> /<?php echo $row['businessType'];?></label></h5>
							<h5 style="margin-bottom:35px;">Capacidad de suministro :<label class="text-primary">SÍ</label></h5>
							</div>
							
							  <div class="col-sm-5" style="border: 1px solid #333;">
							  <h5  style="margin-top:30px;">Nombre del vendedor :<label class="text-primary"><?php echo $row['firstName'];?>   <?php echo $row['lastName'];?></label></h5>
							<h5>Tiempo de respuesta : <label class="text-primary">En 24 horas</label></h5>
							<h5 style="margin-bottom:50px;">Tasa de respuesta :<label class="text-primary">100 %</label></h5>
							</div>
							   <div class="col-sm-2" style="border: 1px solid #333;">
							    <ul class="list list-inline">
   
						<a href="contactsupplier.php?supplieremail=<?php echo  $row['email']; ?>"><h5  style="margin-top:65px; margin-bottom:85px; margin-left:10px;" type="button" class="btn btn-success btn-md round" >Contactar al proveedor</h5></a>
	...
	<div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" style="float:left;">Preguntar al proveedor</h4>
                    ...
                    <div class="col-xs-12 col-sm-2">
                        ...
                        <ul class="nav nav-tabs style2 tabs-left">
                            <li class="active"><a href="#description" data-toggle="tab">	detalles del producto</a>
							  ...
							  <li ><a href="#companyinfo" data-toggle="tab">Información de la compañía</a>
							  </li>
                        ...
                        <div class="tab-content style2">
                            <div class="tab-pane active" id="description">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <dl class="dl-horizontal">
                                            <dt>ID de correo de la empresa:</dt>
                                            <dd><?php echo $rows['email']; ?></dd>
                                            <dt>Descripción de la compañía</dt>
