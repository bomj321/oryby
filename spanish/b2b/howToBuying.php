	...
	include('middlebar.php');
	 ...
	 <!-- end topBar -->
	   ...
	   ?>
		...
		$qry1="SELECT * FROM aboutus WHERE elementname='howbuyingelement1'"; 
	   ...
	   $rw['description'];
		?>
			...
			<?php
			$qry2="SELECT * FROM aboutus WHERE elementname='howbuyingelement2'"; 
	   ...
	   $rw2['description'];
		?>
					  <div class="col-sm-4">
						...
						<?php
			$qry3="SELECT * FROM aboutus WHERE elementname='howbuyingelement3'"; 
