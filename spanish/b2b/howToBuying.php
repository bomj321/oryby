	...
	include('middlebar.php');
	 ...
	 <!-- end topBar -->
	   ...
	   ?>
		...
		$qry1="SELECT * FROM aboutus WHERE elementname='howbuyingelement1spanish'"; 
	   ...
	   $rw['description'];
		?>
			  ...
			  <div class="row">
                    <div class="col-sm-8 col-sm-offset-2">
                        <div class="title-wrap">
                            <h2 class="title lines">Cómo comprar</h2>
			...
			<?php
			$qry2="SELECT * FROM aboutus WHERE elementname='howbuyingelement2spanish'"; 
	   ...
	   $rw2['description'];
		?>
					  <div class="col-sm-4">
						...
						<?php
			$qry3="SELECT * FROM aboutus WHERE elementname='howbuyingelement3spanish'"; 
