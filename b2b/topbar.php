                ...
                <ul class="topBarNav pull-right">
                    ...
                    <li class="linkdown" >
                        ...
                        <ul class="w-100">
                            ...
                            <li><a href="javascript:void(0);"><img src="img/flags/flag-spain.jpg" class="mr-5" alt="">Spain</a>
							</li>
                        </ul>
                    </li>
				 ...
				 $userType = $_SESSION['utype'];
					...
					?>
                        <ul class="w-150">
							...
							<li><a href="myorybue.php">Favorites</a></li>
								<li >
					...
					?>
					   <ul class="w-150">
							...
							<li><a href="buyerprofile.php">My Account</a></li> 
