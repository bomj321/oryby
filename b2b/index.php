...
<div id="Carousel2" class="carousel slide" style="background-color:#ffffff;">
	...
	?>
                              ...
                              <div class="col-md-2"><a href="Shopsingle.php?pid=<?php echo $pid ?>" class="thumbnail" id="carousel2-selector-0"><img src="images/<?php echo $cl[0];?>" alt="Image" style="width:250px;height:200px;"></a>
...
<!-- ////////////////////////////////////// -->
	...
	$cl = explode(',', $myString);
			 ...
			 echo $sqll="SELECT seller.company_name FROM users  INNER JOIN seller ON(users.email = seller.email) Where users.user_id='$userId'";
	...
	echo $companyName=$rows['company_name'];
...
<div id="Carousel" class="carousel slide">
	...
	?>
                              <div class="col-md-2"><a href="Shopsingle.php?pid=<?php echo $pid ?>" class="thumbnail" id="carousel-selector-0"><img src="images/<?php echo $cl[0];?>" alt="Image" style="width:200px;height:200px;"></a>
...
<div id="Carousel1" class="carousel slide">
	...
	?>
                              <div class="col-md-2"><a href="Shopsingle.php?pid=<?php echo $pid ?>" class="thumbnail" id="carousel1-selector-0"><img src="images/<?php echo $cl[0];?>" alt="Image" style="width:200px;height:200px;"></a>
