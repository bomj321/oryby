						...
						<article class="col-xs-12 col-sm-8 col-md-12 col-lg-12">
								...
								<div class="jarviswidget" id="wid-id-5" data-widget-colorbutton="false"	data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-sortable="false">
									...
									<div>
										...
										<form method="post" action="advertisement_add_action.php" enctype="multipart/form-data" class="form-horizontal">

										<fieldset>
													
													<div class="form-group">
														<select class="form-control" name="elementname"> 
														<option class="form-control" value="" >Select Element Name</option>														<option class="form-control" value="advertisement" >Advertisement</option>
														<option class="form-control" value="banner1">Banner 1</option>
														<option class="form-control" value="banner2">Banner 2</option>
														</select>
													</div>
												</fieldset>
												<fieldset>
