...
?>
 ...
 <div id="chat_data">
 <br><br>
 Name:&nbsp;&nbsp;&nbsp;<span style="color:darkgreen;"><?php echo $_SESSION['firstName']; ?>  </span><span style="margin-left:100px"></span>
  Email: &nbsp;&nbsp;&nbsp;<span style="color:darkgreen;"><?php echo $_SESSION["email"]; ?></span>
