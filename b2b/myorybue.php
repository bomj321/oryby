...
$logorow=mysqli_fetch_array($logoresult);  ?>
 ...
 <form action="product_add.php" method="POST">
  &nbsp; &nbsp;
  <input type="submit" class="btn"  value="   Availabe Top List is   :<?php echo $row['limitTopList'];?> " style="padding-right:5px;margin-right:30px;">   
 
  <input type="submit" class="btn"  value="   Show Case   :<?php echo $row['limitShowCase'];?>" style="margin-right:150px;"> 
    <button type="button" class="btn btn-success btn-round">Buy More</button>
 </form>
