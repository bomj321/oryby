                    ...
                    <div class="col-sm-10 col-sm-offset-1">
                        <form method="POST">
                            <div class="form-group">
                                ...
                                <input type="text" id="name" class="form-control input-lg" placeholder="Name" name="uzername" value="<?php echo $_SESSION['fname']; ?>">
                            </div>
                            <div class="form-group">
                                <label for="email">Email Address</label>
                                <input type="text" id="email" class="form-control input-lg" placeholder="E-mail" value="<?php echo $_SESSION['uemail']; ?>" name="email">
                            </div>
                            <div class="form-group">
