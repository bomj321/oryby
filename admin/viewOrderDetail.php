								...
								<div>
									...
									<!-- end widget edit box -->
											...
											<div class="row">
												...
												<div class="col-sm-12">
												<center><h1 style="font-weight: bold;">		ORDER DETAILS
												</h1></center>
												</div>
								...
								<div>
									...
									<!-- end widget edit box -->
											...
											<div class="row">
												...
												<div class="col-sm-12">
												<center><h1 style="font-weight: bold;">		Proudcts Detail
												</h1></center>
												</div>
								...
								<div>
									...
									<!-- end widget edit box -->
											...
											<div class="row">
												...
												<div class="col-sm-12">
												<center><h1 style="font-weight: bold;">		Buyer Detail
												</h1></center>
												</div>
								...
								<div>
									...
									<!-- end widget edit box -->
											...
											<div class="row">
												...
												<div class="col-sm-12">
												<center><h1 style="font-weight: bold;">		Seller Detail
												</h1></center>
												</div>
...
include('Connect.php');
$order_id=$_GET['id'];
 $sql="SELECT * FROM  orders INNER JOIN orderDetail ON(orders.order_id = orderDetail.order_id)  INNER JOIN products ON(orderDetail.pid= products.pid) INNER JOIN users ON(products.user_id= users.user_id) INNER JOIN seller ON(users.email=seller.email) Where orders.order_id='$order_id'";
