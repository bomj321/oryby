...
$row=mysqli_fetch_array($stmtt);
 $user_id =$row['user_id'];
  $sql="SELECT * FROM users INNER JOIN access  ON  (users.user_id = access.user_id) INNER JOIN page  ON  (access.pageId = page.pageId) WHERE  access.status ='1'  AND access.pageId='22' AND access.user_id='$user_id' ";
...
?>
		...
		<?php
include('Connect.php');
 $sql="SELECT * FROM aboutus Where elementname ='QuestionHeading' OR elementname='Question1' OR elementname='Question2'  OR elementname='Question3'  OR elementname='Question4' OR elementname='QuestionHeadingspanish' OR elementname='Question1spanish' OR elementname='Question2spanish' OR elementname='Question3spanish' OR elementname='Question4spanish'";
									...
									<div class="widget-body no-padding table-responsive">
										...
										<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
											...
											?>
												...
												<td> 
         <a    href="updatetellus.php?id=<?php echo $row['id'];?>"><i class="fa fa-pencil fa-fw"></i></a></td>
												</tr>
								<?php
								}
								}
...
function contact_Id(id)
{
   if(confirm('Sure To Remove This Record ?'))
     {
          window.location.href='deletePolicy.php?aboutid='+id;
     }
     else
     {
