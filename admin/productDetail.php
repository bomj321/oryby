...
$sql="UPDATE products  SET  productType='".$evaluate."' WHERE (pid='$pid')";
	...
	?>
		...
		<div class="form-group">
			<label>Product Name</label>
			  <input type="text" class="form-control" placeholder="Enter Name" name="ntitle" disabled id="ntitle" value="<?php echo $ntitle; ?>"
			  />
	</div>
	<div class="form-group">
			<h3>Evaluate / Change </h3>
			...
			<div class="form-group">
			  ...
			  <input type="text" class="form-control" placeholder="Enter Price" name="price" disabled id="price" value="<?php echo $price; ?>"/>
			</div>
			<div class="form-group">
				<label>Product Description</label>
			  <input type="text" class="form-control" placeholder="Enter Description" disabled name="fulldescription" id="fulldescription" value="<?php echo $fulldescription; ?>"/>
			</div>
		...
		{
		?>
		<input type="text" class="form-control"  name="fulldescription" id="fulldescription"  disabled value="Show Case Product"/>
		...
		{
		?>
		  <input type="text" class="form-control"  name="fulldescription" id="fulldescription" disabled value="Not Show Case Product"/>
		...
		{
		?>
	  <input type="text" class="form-control" name="fulldescription" id="fulldescription" disabled value="Top List Product"/>
				<?php
		}
		else
		{
		?>
		  <input type="text" class="form-control"  name="fulldescription" id="fulldescription" disabled value="Not Top List Product"/>
			<?php
