										...
										<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
											<thead>
												<tr>
													...
													<th > Type</th>
													<th data
													-class="expand"><i class="fa fa-fw fa-user text-muted hidden-md hidden-sm hidden-xs"></i> Description</th>
														<th > Action</th>
											...
											?>
												...
												<td>
         <a    href="updateCheckout.php?id=<?php echo $row['id'];?>"><i class="fa fa-pencil fa-fw"></i></a></td>
												</tr>
								<?php
								}
								}
