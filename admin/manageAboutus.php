...
$row=mysqli_fetch_array($stmtt);
 $user_id =$row['user_id'];
  $sql="SELECT * FROM users INNER JOIN access  ON  (users.user_id = access.user_id) INNER JOIN page  ON  (access.pageId = page.pageId) WHERE  access.status ='1'  AND access.pageId='9' AND access.user_id='$user_id' ";
...
?>
          ...
          <div class="row">
            ...
            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
              ...
              <div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
                ...
                -->
                  <center><a href="about_add.php" class="btn btn-primary"><i class="fa fa-floppy"></i> Add Content</a>
           </br>
    ...
    <?php
include('Connect.php');
 $sql="SELECT * FROM aboutus Where elementname ='PageSpanish' OR elementname='PageEnglish'";
                    ...
                    <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                      <thead>                     
                        <tr>
                          ...
                          <th > Link</th>
                          <th>Titlemission</th>
                          <th>Descriptionmission</th>
                          <th>Subtitlemission</th>
                          <th>Subtitles</th>
                            <th > Action</th>
                      ...
                      ?>
                        <tr>
                          ...
                          <td><?php echo $row['titlemission']; ?></td>                         
                          <td><?php echo $row['descriptionmission']; ?></td>                              <td><?php echo $row['subtitlemission']; ?></td>
                          <td><?php echo $row['subtitles']; ?></td>
                        <td> 
         <a    href="javascript:contact_Id(<?php echo $row['id'];?>)"><i class="fa fa-trash-o fa-lw"></i></a> &nbsp; &nbsp;&nbsp; &nbsp; <a    href="updateAboutus.php?id=<?php echo $row['id'];?>"><i class="fa fa-pencil fa-fw"></i></a></td>
                        </tr>
                <?php
                }
                }
...
function contact_Id(id)
{
   if(confirm('Sure To Remove This Record ?'))
     {
          window.location.href='deleteAbout.php?aboutid='+id;
     }
     else
     {
