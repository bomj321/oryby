	...
	include('middlebar.php');
	 ...
	 <!-- end topBar -->
	   ...
	   ?>
		...
		$qry1="SELECT * FROM aboutus WHERE elementname='buysecurtlyelement1'"; 
			  ...
			  <div class="row">
                    <div class="col-sm-8 col-sm-offset-2">
                        <div class="title-wrap">
                            <h2 class="title lines">Buy Securtly</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5 vertical-align">
                        ...
                        <figure class="zoom-in">
                          ...
                          <hr class="spacer-100">
                          <?php 
		$qry2="SELECT * FROM aboutus WHERE elementname='buysecurtlyelement2'"; 
	   ...
	   $nr =mysqli_num_rows($res2);
		?>    
				...
				<div class="col-sm-5 vertical-align">
                        <?php
                        $sql="Select * from `images` Where id='26'";
                        $result=mysqli_query($connection,$sql);
                        $row=mysqli_fetch_array($result);
                        $image=$row['image'];
                        ?>
                    ...
                    <hr class="spacer-100">
                             <?php 
		$qry3="SELECT * FROM aboutus WHERE elementname='buysecurtlyelement3'"; 
	   ...
	   $nr =mysqli_num_rows($res3);
		?>  
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5 vertical-align">
                        <?php
                        $sql="Select * from `images` Where id='27'";
                        $result=mysqli_query($connection,$sql);
                        $row=mysqli_fetch_array($result);
                        $image=$row['image'];
                        ?>
